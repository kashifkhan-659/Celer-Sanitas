...
//
// Nothing here ever logs a value — the failure names the VARIABLE only. The Claude key is
// server-side only and must never reach the client bundle (Architecture.md §1).
const REQUIRED = [
  'CLAUDE_API_KEY',                 // Claude API — Jobs A/B/C
...
export const CLAUDE_API_KEY = process.env.CLAUDE_API_KEY.trim();
